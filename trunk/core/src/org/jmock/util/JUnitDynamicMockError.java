 ...
 * @since 1.0
 */
public class JUnitDynamicMockError extends JUnitMockAssertionError implements DynamicMockError
{
   private final InvocationDispatcher dispatcher;
   private final DynamicMock dynamicMock;
   private final Invocation invocation;

   public JUnitDynamicMockError( DynamicMock dynamicMock, Invocation invocation,
